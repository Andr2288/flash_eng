...
import { KeyRound, Loader, Sparkles } from "lucide-react";
...
const ResetPasswordPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setInfo("Пароль успішно оновлено. Перенаправляємо на сторінку входу…");
            setTimeout(() => {
            ...
            setError(
                err.message ||
                    "Не вдалося оновити пароль. Спробуйте знову через лист відновлення."
            );
        } finally {
            setSubmitting(false);
        }
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 sm:p-10">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-gray-500 text-sm mt-1 text-center">
                            Встановіть новий пароль для акаунту
                        </p>
                    </div>
